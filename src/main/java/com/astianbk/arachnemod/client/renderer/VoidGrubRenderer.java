...
import com.astianbk.arachnemod.client.model.VoidGrubModel;
import com.astianbk.arachnemod.client.render_state.VoidGrubRenderState;
import com.astianbk.arachnemod.server.entity.VoidGrubEntity;
...
public class VoidGrubRenderer<T extends VoidGrubEntity,R extends VoidGrubRenderState,M extends VoidGrubModel<R>> extends MobRenderer<T,R,M> {
    public VoidGrubRenderer(EntityRendererProvider.Context context) {
        ...
        this.addLayer(new EyesLayer<>(this) {
            ...
            public RenderType renderType() {
                return RenderTypes.eyes(Identifier.fromNamespaceAndPath(AracneMod.MODID, "textures/entity/void_grub/voidgrub_eyes.png"));
            }
        });
    }
    ...
    public R createRenderState() {
        return (R) new VoidGrubRenderState();
    }


    @Override
    public Identifier getTextureLocation(R r) {
        return Identifier.fromNamespaceAndPath(AracneMod.MODID,"textures/entity/void_grub/voidgrub.png");
    }
