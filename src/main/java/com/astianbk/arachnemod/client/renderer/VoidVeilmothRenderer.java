...
public class VoidVeilmothRenderer<T extends VoidVeilmothEntity,R extends VoidVeilmothRenderState,M extends VoidVeilmothModel<R>> extends MobRenderer<T,R,M> {
