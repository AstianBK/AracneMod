...
public class VoidVeilmothAnim {
	public static final AnimationDefinition idle = AnimationDefinition.Builder.withLength(1.0F).looping()
			...
			.addAnimation("sec1", new AnimationChannel(AnimationChannel.Targets.ROTATION,
			...
			.addAnimation("sec3", new AnimationChannel(AnimationChannel.Targets.ROTATION,
					new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
			...
			.addAnimation("legleft", new AnimationChannel(AnimationChannel.Targets.ROTATION,
					...
					new Keyframe(0.25F, KeyframeAnimations.degreeVec(0.0F, 17.5F, 72.5F), AnimationChannel.Interpolations.CATMULLROM),
			...
			.addAnimation("torso", new AnimationChannel(AnimationChannel.Targets.POSITION,
					...
					new Keyframe(0.2083F, KeyframeAnimations.posVec(0.0F, -0.575F, 0.475F), AnimationChannel.Interpolations.CATMULLROM),
					new Keyframe(0.4167F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
					new Keyframe(0.6667F, KeyframeAnimations.posVec(0.0F, -0.575F, 0.475F), AnimationChannel.Interpolations.CATMULLROM),
			...
			.addAnimation("legright3", new AnimationChannel(AnimationChannel.Targets.ROTATION,
					new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, -72.5F), AnimationChannel.Interpolations.CATMULLROM),
					new Keyframe(0.2917F, KeyframeAnimations.degreeVec(0.0F, 17.5F, -72.5F), AnimationChannel.Interpolations.CATMULLROM),
					new Keyframe(0.6667F, KeyframeAnimations.degreeVec(0.0F, -7.5F, -72.5F), AnimationChannel.Interpolations.CATMULLROM),
					new Keyframe(1.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, -72.5F), AnimationChannel.Interpolations.CATMULLROM)
			))
	...
	public static final AnimationDefinition wingson = AnimationDefinition.Builder.withLength(0.5F).looping()
	...
	public static final AnimationDefinition wingsoff = AnimationDefinition.Builder.withLength(0.25F).looping()
			.addAnimation("wingleft", new AnimationChannel(AnimationChannel.Targets.ROTATION,
