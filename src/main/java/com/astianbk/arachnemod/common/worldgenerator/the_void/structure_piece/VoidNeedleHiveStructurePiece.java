...
public class VoidNeedleHiveStructurePiece extends TemplateStructurePiece {
    ...
    public VoidNeedleHiveStructurePiece(int genDepth, StructureTemplateManager structureTemplateManager, StructurePlaceSettings placeSettings, BlockPos position) {
        super(NRegistry.VOID_NEEDLE_HIVE_PIECE.get(), genDepth, structureTemplateManager, Identifier.fromNamespaceAndPath(AracneMod.MODID,"needle_hive"), "arachnemod:needle_hive", placeSettings, position);
    ...
    public void postProcess(WorldGenLevel level, StructureManager structureManager, ChunkGenerator generator, RandomSource random, BoundingBox chunkBB, ChunkPos chunkPos, BlockPos referencePos) {
        AracneMod.LOGGER.info("ZIGURAT: pieceBB={} chunkBB={} templatePos={} referencePos={} chunk={}", this.boundingBox, chunkBB, this.templatePosition, referencePos, chunkPos);
        AracneMod.LOGGER.info("TEMPLATE: size={}x{}x{}", this.template.getSize().getX(), this.template.getSize().getY(), this.template.getSize().getZ());
